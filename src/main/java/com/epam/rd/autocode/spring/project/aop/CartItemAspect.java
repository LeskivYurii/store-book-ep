...
public class CartItemAspect {
    ...
    @Around(
            value = "execution(public void addItemToCart(com.epam.rd.autocode.spring.project.dto.request.AddCartItemRequest))")
    public void addItemToCartAdvice(ProceedingJoinPoint joinPoint) throws Throwable {
        CustomLogger.log(log, "ADD_ITEM_TO_CART_REQUEST", "ADD_ITEM_TO_CART_RESPONSE", joinPoint);
    }
    ...
    public void deleteItemFromCartAdvice(ProceedingJoinPoint joinPoint) throws Throwable {
        CustomLogger.log(log, "DELETE_ITEM_FROM_CART_REQUEST", "DELETE_ITEM_FROM_CART_RESPONSE", joinPoint);
    }
